            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="info-widget">
                                        ...
                                        <div class="exist-customer">
                                            ...
                                            <a href="patient_profile?id=${sessionScope.acc.id}">Click here!</a>
                                        </div>
                                    </div>
                                        ...
                                        <form action="bookappointment" method="post">
                                            <div class="payment-widget">
                                                ...
                                                <div class="submit-section mt-4">
                                                    <button type="submit" class="btn btn-primary submit-btn" onclick="return confirm('Are you sure you want to book appointment with this doctor?');">Booking</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <c:set var="feedbackList" value="${dao.getFeedbackByDoctorID(doctor.id)}"></c:set>
                                ...
                                <div class="card booking-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="booking-doc-info">
                                            <a href="dtinfo?id=${doctor.id}" class="booking-doc-img">
                                            <img src="data:image/jpeg;base64,${doctor.imageString}" alt="User Image" />
                                        </a>
                                        <div class="booking-info">
                                            <h4>
                                                <a href="doctor_profile_view?id=${doctor.id}">${doctor.doctorName}</a>
                                            </h4>
                                            <div class="rating">
